...
set statusline=%F%m%r%h%w%y[%l,%v][%p%%] " Customize status line
...
" Uncomment the following line for leading whitespace version
" set listchars=tab:▸.,trail:·,extends:>,precedes:<,nbsp:␣,conceal:·,leadmultispace:⎸\ \ \ ,
...
if has('statusline') && &t_Co > 2 || has('gui_running')
  ...
  func s:StatusLine()
    ...
    " Bacause the longest filetype name is `upstreaminstalllog`, it seems
